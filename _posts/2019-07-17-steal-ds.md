...
You never know what they actually do. In addition, some governments do not miss the opportunity and publish their modifications, with tools for tracking the users. Applications with government surveillance are malicious by definition. One day I studied a malicious application (Virustotal result, sample, password: infected), which scanned the phone for telegram clones:
