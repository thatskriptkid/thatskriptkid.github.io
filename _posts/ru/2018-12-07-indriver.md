...
_Впервые я про это рассказал на 2600 (7.12.2018), KHS Community в Караганде (27.03.2019), KHS Community в Алматы (13.04.2019). Публикую, так как InDriver поменял API и теперь этот функционал недоступен._

_Эта статья собрана из презентации, которую вы можете скачать:_
